...
import { ProductoService, CategoriaService, UnidadMedidaService, MarcaService, EgresoService, ComprobanteService } from '../core/service';
...
@NgModule({
  ...
  providers: [ComprobanteService, ProductoService, CategoriaService, UnidadMedidaService, MarcaService, EgresoService]
})
