...
@Component({
  ...
  template: `
    <div class="modal-header">
      <h4 class="modal-title">Cantidad/es de Defectuoso/s del Producto </h4>
...
export class ProductoDefectuosoModalContent {
...
@Component({
  selector: 'agregar-producto-defectuoso-modal',
  templateUrl: './producto-defectuoso-modal.component.html',
  styleUrls: ['./producto-defectuoso-modal.component.scss']
})
export class ProductoDefectuosoModalComponent {
  @Input("producto") public producto:number;
  @Input("cantidadProductoMaximo") public cantidadProductoMaximo;
  @Output("actualizarProductoDefectuoso") public actualizarProductoDefectuoso = new EventEmitter();

  constructor( private _modalService: NgbModal ) { }

  open() {
    const modalRef = this._modalService.open(ProductoDefectuosoModalContent);
    ...
    modalRef.result.then(
      (result) => {
          if (result == 'close') {
              ...
              return this.actualizarProductoDefectuoso.emit(result);
          }
      }
    );
  }
